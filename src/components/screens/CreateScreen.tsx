      ...
      <div className="relative z-10 h-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 h-full auto-rows-fr">
          ...
          <div 
            ...
            className="glass-card-premium p-6 bg-gradient-to-br from-violet-500/10 via-purple-500/10 to-fuchsia-500/10 hover:from-violet-500/20 hover:via-purple-500/20 hover:to-fuchsia-500/20 border-violet-500/20 hover:border-violet-500/40 cursor-pointer group glass-hover-lift glass-scale col-span-1 sm:col-span-2 lg:col-span-1"
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-violet-500/30 to-fuchsia-500/30 flex items-center justify-center group-hover:scale-110 transition-transform glass-glow">
          ...
          <div 
            ...
            className="glass-card-premium p-6 bg-gradient-to-br from-amber-500/10 via-orange-500/10 to-red-500/10 hover:from-amber-500/20 hover:via-orange-500/20 hover:to-red-500/20 border-amber-500/20 hover:border-amber-500/40 cursor-pointer group glass-hover-lift glass-scale"
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-amber-500/30 to-red-500/30 flex items-center justify-center group-hover:scale-110 transition-transform glass-glow">
          ...
          <div 
            ...
            className="glass-card-premium p-6 bg-gradient-to-br from-cyan-500/10 via-blue-500/10 to-indigo-500/10 hover:from-cyan-500/20 hover:via-blue-500/20 hover:to-indigo-500/20 border-cyan-500/20 hover:border-cyan-500/40 cursor-pointer group glass-hover-lift glass-scale"
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-cyan-500/30 to-indigo-500/30 flex items-center justify-center group-hover:scale-110 transition-transform glass-glow">
          ...
          <div 
            ...
            className="glass-card-premium p-6 bg-gradient-to-br from-emerald-500/10 via-teal-500/10 to-cyan-500/10 hover:from-emerald-500/20 hover:via-teal-500/20 hover:to-cyan-500/20 border-emerald-500/20 hover:border-emerald-500/40 cursor-pointer group glass-hover-lift glass-scale"
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-emerald-500/30 to-cyan-500/30 flex items-center justify-center group-hover:scale-110 transition-transform glass-glow">
          ...
          <div 
            ...
            className="glass-card-premium p-6 bg-gradient-to-br from-rose-500/10 via-pink-500/10 to-fuchsia-500/10 hover:from-rose-500/20 hover:via-pink-500/20 hover:to-fuchsia-500/20 border-rose-500/20 hover:border-rose-500/40 cursor-pointer group glass-hover-lift glass-scale"
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-rose-500/30 to-fuchsia-500/30 flex items-center justify-center group-hover:scale-110 transition-transform glass-glow">
                  <Target size={20} className="text-rose-300" />
                </div>
          ...
          <div 
            ...
            className="glass-card-premium p-6 bg-gradient-to-br from-yellow-500/10 via-lime-500/10 to-emerald-500/10 hover:from-yellow-500/20 hover:via-lime-500/20 hover:to-emerald-500/20 border-yellow-500/20 hover:border-yellow-500/40 cursor-pointer group glass-hover-lift glass-scale"
          >
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-yellow-500/30 to-emerald-500/30 flex items-center justify-center group-hover:scale-110 transition-transform glass-glow">
