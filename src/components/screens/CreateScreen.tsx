    ...
    <div className="h-screen bg-black relative overflow-hidden flex flex-col">
      ...
      <div className="relative z-10 flex-1 flex flex-col pb-20">
        ...
        <div className="flex-1 overflow-y-auto px-6 space-y-6">
          ...
          {/* Induction Selection */}
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-4 border border-white/10">
            <label className="block text-white/80 text-sm font-medium mb-3">Induction Technique</label>
          ...
          {/* Goals */}
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-4 border border-white/10">
            <label className="block text-white/80 text-sm font-medium mb-3">Goals & Suggestions</label>
            ...
            <div className="flex space-x-2 mb-3">
              <input
                ...
                className="flex-1 bg-white/10 border border-white/20 rounded-lg px-3 py-2 text-white placeholder-white/50 focus:outline-none focus:border-teal-400/50"
                onKeyPress={(e) => e.key === 'Enter' && addGoal()}
              />
              <button
                onClick={addGoal}
                className="px-4 py-2 bg-teal-500/20 border border-teal-500/40 rounded-lg text-teal-400 hover:bg-teal-500/30 transition-colors"
              >
                <Plus size={16} />
              </button>
            </div>
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-2xl p-4 border border-white/10">
            ...
            <div className="flex space-x-2 mb-3">
              ...
              <button
                onClick={addMetaphor}
                className="px-4 py-2 bg-orange-500/20 border border-orange-500/40 rounded-lg text-orange-400 hover:bg-orange-500/30 transition-colors"
              >
                <Plus size={16} />
              </button>
            </div>
        ...
        <div className="flex-shrink-0 px-6 pt-4">
          <div className="flex space-x-3">
            <button
              onClick={handleSave}
              disabled={!isValid}
              className="flex-1 px-6 py-3 bg-gradient-to-r from-teal-400 to-cyan-400 rounded-lg text-black font-semibold hover:scale-105 transition-transform duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:scale-100"
            >
            ...
            <button
              ...
              disabled={!isValid}
              className="px-6 py-3 bg-white/10 hover:bg-white/20 border border-white/20 rounded-lg text-white font-medium transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
            >
