    ...
    <div className="bg-black relative px-4 py-4 h-full overflow-hidden">
      ...
      <div className="relative z-10 h-full">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 h-full auto-rows-fr">
          ...
          <div 
            className="glass-card-premium p-5 bg-gradient-to-br from-purple-500/10 to-teal-500/10 hover:border-purple-500/40 hover:shadow-lg hover:shadow-purple-500/20 cursor-pointer group glass-hover-lift"
