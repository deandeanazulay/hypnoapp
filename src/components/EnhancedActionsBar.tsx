...
import { Target, Settings, Mic, ChevronDown, Zap, Heart, Plus, Edit2, X, DollarSign, Sparkles, Palette, Waves, Bird, Brain, Sun, Hop as Rope, Eye, Shield, Flame, Star, AArrowDown as Om, Moon, Rocket } from 'lucide-react';
