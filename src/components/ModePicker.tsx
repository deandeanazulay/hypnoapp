...
const modes: Mode[] = [
  {
    id: 'guided-voice',
    name: 'Guided Voice',
    description: 'AI speaks throughout, full guidance',
    icon: <Volume2 size={20} className="text-teal-400" />,
    color: 'from-teal-500/20 to-cyan-500/20',
    features: ['Continuous AI guidance', 'Voice interaction', 'Subtitles available', 'Full experience']
  },
  {
    id: 'silent-orb',
    name: 'Silent Orb',
    description: 'Visual only, perfect for public spaces',
    icon: <VolumeX size={20} className="text-purple-400" />,
    color: 'from-purple-500/20 to-blue-500/20',
    features: ['Visual guidance only', 'Breathing patterns', 'Color transitions', 'Silent operation']
  },
  {
    id: 'hands-free',
    name: 'Hands-Free',
    description: 'Voice commands: pause, skip, deeper',
    icon: <Mic size={20} className="text-orange-400" />,
    color: 'from-orange-500/20 to-amber-500/20',
    features: ['Voice commands', 'Eyes-closed friendly', 'Minimal interaction', 'Deep immersion']
  }
];

const durations = [
  { id: '5', name: '5 min', description: 'Quick session' },
  { id: '10', name: '10 min', description: 'Standard' },
  { id: '15', name: '15 min', description: 'Deep work' },
  { id: '20', name: '20 min', description: 'Full journey' }
];
...
export default function ModePicker({ onSelect, onClose }: ModePicker) {
