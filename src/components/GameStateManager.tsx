          ...
          <div className="flex items-center space-x-3">
            ...
            <div className="flex-1 relative">
              ...
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 p-2 bg-teal-500/20 hover:bg-teal-500/30 border border-teal-500/40 rounded-lg text-teal-400 transition-all hover:scale-110 disabled:opacity-50"
              >
                <Send size={16} />
              </button>
            </div>
